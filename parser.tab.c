...
{
  "$end", "error", "$undefined", "NUM", "ID", "INT", "BOOL", "VOID",
  "MAIN", "RETURN", "TRUE", "FALSE", "PLUS", "MULT", "ASSIGN", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", "COMMA", "$accept", "program",
  "main_decl", "type", "block", "decl_list", "decl", "var_list",
...
{
      29,   -11,   -11,   -11,     5,    -2,    30,   -11,   -11,   -11,
       4,    29,    21,    35,   -11,     0,   -11,   -11,    -9,    26,
      -3,   -11,   -11,   -11,    37,    10,   -11,   -11,   -11,   -11,
      10,   -11,    11,   -11,    14,   -10,    10,    10,   -11,   -11,
     -11,    19,    19
};
...
{
       0,     4,     5,     6,     0,     0,     0,     1,     9,     2,
       0,    14,     0,     0,     8,     0,     3,    12,     0,     0,
       0,     7,    13,    10,     0,     0,    21,    22,    23,    24,
       0,    17,     0,    11,     0,     0,     0,     0,    16,    15,
      20,    18,    19
};
...
{
      26,    27,    36,    37,    19,     7,    40,    28,    29,    20,
      23,    24,    30,    26,    27,     8,    31,    34,    21,    12,
      28,    29,    35,    36,    37,    30,    36,    37,    41,    42,
      38,    36,    37,    39,     1,     2,     3,    16,    10,    17,
      25,    33,    13
};

static const yytype_int8 yycheck[] =
{
       3,     4,    12,    13,     4,     0,    16,    10,    11,     9,
      19,    20,    15,     3,     4,    17,    19,    25,    18,    15,
      10,    11,    30,    12,    13,    15,    12,    13,    36,    37,
      19,    12,    13,    19,     5,     6,     7,    16,     8,     4,
      14,     4,    11
};
...
{
       0,     5,     6,     7,    22,    23,    24,     0,    17,    25,
       8,    26,    15,    24,    27,    29,    16,     4,    28,     4,
       9,    18,    30,    19,    20,    14,     3,     4,    10,    11,
      15,    19,    31,     4,    31,    31,    12,    13,    19,    19,
      16,    31,    31
};
...
#line 33 "parser.y"
    {
        (yyval.node) = createNode(0, 0, "PROGRAM", (yyvsp[-1].node), (yyvsp[0].node));
        printf("Programa parseado correctamente\n");
        printf("\n=== AST ===\n");
        printAST((yyval.node), 0);
        printSymbolTable();
        printf("\n=== PSEUDO-ASSEMBLY ===\n");
